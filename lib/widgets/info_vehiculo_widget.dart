...
class InfoVehiculoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (inspeccionProvider.vehiculoSelected == null) {
    ...
    return Column(
      children: [
        ...
        ListTile(
          ...
          subtitle: Text(inspeccionProvider.vehiculoSelected!.modelo.toString(),
              style: TextStyle(fontSize: 15)),
        ),
        ListTile(
          dense: true,
        ...
        ListTile(
          ...
          subtitle: Text(inspeccionProvider.vehiculoSelected!.color.toString(),
              style: TextStyle(fontSize: 15)),
        ),
      ],
    );
