...
class Pdf {
  ...
  factory Pdf.fromMap(Map<String, dynamic> json) => Pdf(
        ...
        docConductor: List<Documento>.from(
            json["docConductor"].map((x) => Documento.fromMap(x))),
        docVehiculos: List<Documento>.from(
            json["docVehiculos"].map((x) => Documento.fromMap(x))),
