...
class ThemeService extends ChangeNotifier {
  ...
  ThemeData get darkTheme => ThemeData(
        ...
        primarySwatch: Colors.green,
        primaryColor:
            const Color(0xFF39FF14), // Verde brillante como en la imagen
        scaffoldBackgroundColor:
            const Color(0xFF121212), // Gris muy oscuro casi negro
        appBarTheme: AppBarTheme(
        ...
        cardTheme: CardThemeData(
          color: const Color(
              0xFF1E1E1E), // Gris ligeramente más claro que el fondo
          elevation: 4,
          shadowColor: Colors.black.withValues(alpha: 0.3),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
        ...
        textTheme: TextTheme(
          ...
          bodySmall: TextStyle(
              color:
                  const Color(0xFFA0A0A0)), // Gris claro para texto secundario
          labelLarge:
              TextStyle(color: Colors.white, fontWeight: FontWeight.w500),
          labelMedium:
              TextStyle(color: Colors.white, fontWeight: FontWeight.w500),
          labelSmall: TextStyle(
              color: const Color(0xFFA0A0A0), fontWeight: FontWeight.w400),
        ),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          labelStyle: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.w500), // Blanco para mejor contraste
          hintStyle: TextStyle(color: const Color(0xFF808080)),
          floatingLabelStyle: TextStyle(
              color: const Color(0xFF39FF14)), // Verde cuando está enfocado
        ),
        bottomNavigationBarTheme: BottomNavigationBarThemeData(
          backgroundColor:
              const Color(0xFF121212), // Mismo color que el fondo principal
          selectedItemColor: Colors.white, // Blanco para elementos activos
          unselectedItemColor:
              const Color(0xFFA0A0A0), // Gris claro para elementos inactivos
          elevation: 8,
          type: BottomNavigationBarType.fixed,
        ),
